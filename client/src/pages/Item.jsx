...
import DisabledByDefaultIcon from '@mui/icons-material/DisabledByDefault';import Map from "../components/Map.jsx";
...
const Item = () => {
    ...
    return (
        <div className="container-fluid row" style={{ height: "100vh", position: "relative" }}>
            ...
            <div className="col-3" style={{ height: "100vh", overflowY: "auto" }}>
                <div className="my-2 mx-3">
                    ...
                    {/* Listing Description */}
                    <p className="listdescr">{listing.description || "No description provided."}</p>
